package za.co.goosen.repository;

import za.co.goosen.NgBootTodoApp;
import za.co.goosen.config.Constants;
import za.co.goosen.config.audit.AuditEventConverter;
import za.co.goosen.domain.PersistentAuditEvent;
...
import static za.co.goosen.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
